...
if (version < 18) {
  console.log("" + colors.red("[ERROR] fluxo Bot requires a NodeJS version of 18 or higher!\nYou can check your NodeJS by running the \"node -v\" command in your terminal."));
  ...
  let logMsg = "\n\n[" + new Date().toLocaleString() + "] [ERROR] fluxo Bot requires a NodeJS version of 18 or higher!";
